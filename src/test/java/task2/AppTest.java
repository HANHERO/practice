...
public class AppTest {
    ...
    public void startScenarios() {
        ...
        s(1, 1, 1, min + 1, 1073741823);
        s(1, 1, 2, min + 1, 1073741823);
        s(1073741823, 1, 2147483646, min + 1, 1073741823);
        s(1, 2, 2147483647, min + 1, 1073741823);

        s(1, 1, 1, 1073741823, min + 1);
        s(1, 1, 1073741823, 1073741823, min + 1);
        s(2, 1, 2147483646, 1073741823, min + 1);
        s(1, 2, 2147483647, 1073741823, min + 1);

        s(1, 1, 1, max - 1, 1);
        s(1, 1, 2147483646, max - 1, 1);
        s(1, 2, 2147483647, max - 1, 1);

        s(1, 1, 1, 1, max - 1);
        s(2147483646, 1, 2147483646, 1, max - 1);
        s(1, 2, 2147483647, 1, max - 1);
        s(2147483645, 1, 2147483645, 1, max - 1);
        ...
        s(1, 1, 1, min + 1, 1073741823);
        s(1, 1, 2, min + 1, 1073741823);
        s(2, 1, 3, min + 1, 1073741823);
        s(1073741823, 1, 2147483645, min + 1, 1073741823);
        s(1, 2, 2147483647, min + 1, 1073741823);

        s(1, 1, 2, 1073741823, min + 1);
        s(1, 1, 1073741822, 1073741823, min + 1);
        s(2, 1, 1073741824, 1073741823, min + 1);
        s(2, 1, 2147483645, 1073741823, min + 1);
        s(1, 2, 2147483647, 1073741823, min + 1);

        s(1, 1, 2, max - 1, 1);
        s(1, 1, 2147483645, max - 1, 1);
        s(1, 2, 2147483647, max - 1, 1);
        ...
        s(1, 2, 1000001, 1000000, min);
        s(1, 2, 1000002, 1000000, min);

        s(2, 1, 2, min, 1000000);
        s(1, 2, 1000001, min, 1000000);
        s(2, 2, 1000002, min, 1000000);
