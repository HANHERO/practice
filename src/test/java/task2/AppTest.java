...
public class AppTest {
    ...
    public void startScenarios() {
        ...
        s(1, 46341, 46341);
        s(2, 46341, 46341);
        s(1073741823, 46341, 46341);
        s(2147483646, 46341, 46341);
        s(2147483647, 46341, 46341);

        s(0, 46340, 46342);
        s(1, 46340, 46342);
        s(2, 46340, 46342);
        s(1073741823, 46340, 46342);
        s(2147483646, 46340, 46342);
        s(2147483647, 46340, 46342);
        ...
        s(1, 1, 1073741822, max / 2, min);
        s(1, 1, 1073741823, max / 2, min);
        s(1, 2, 1073741824, max / 2, min);
        s(1, 2, 1073741825, max / 2, min);
        ...
        s(1, 2, 2147483645, max / 2, min);
        s(1, 2, 2147483646, max / 2, min);
        s(1, 3, 2147483647, max / 2, min);
        ...
        s(1073741822, 1, 1073741822, min, max / 2);
        s(1073741823, 1, 1073741823, min, max / 2);
        s(1, 2, 1073741824, min, max / 2);
        s(2, 2, 1073741825, min, max / 2);
