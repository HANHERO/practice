...
public class MainTest {
    ...
    @Test public void b1() { aE("A = -2147483648, B = -2147483648", s(min, min)); }
    @Test public void b2() { aE("A = 2147483647, B = 2147483647", s(max, max)); }
    @Test public void b3() { aE("A = -2147483648, B = 2147483647", s(max, min)); }
    @Test public void b4() { aE("A = 2147483647, B = -2147483648", s(min, max)); }
    ////////////////////////////////2.2 Впритык справа и слева от границы
    @Test public void p1() { aE("A = -2147483647, B = -2147483648", s(min, min + 1)); }
    @Test public void p2() { aE("A = -2147483648, B = -2147483647", s(min + 1, min)); }

    @Test public void p3() { aE("A = 2147483647, B = 2147483646", s(max - 1, max)); }
    @Test public void p4() { aE("A = 2147483646, B = 2147483647", s(max, max - 1)); }

    @Test public void p5() { aE("A = -2147483648, B = 2147483646", s(max - 1, min)); }
    @Test public void p6() { aE("A = -2147483647, B = 2147483647", s(max, min + 1)); }

    @Test public void p7() { aE("A = 2147483647, B = -2147483647", s(min + 1, max)); }
    @Test public void p8() { aE("A = 2147483646, B = -2147483648", s(min, max - 1)); }
