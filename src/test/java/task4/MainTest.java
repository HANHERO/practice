...
public class MainTest {
    ...
    @Test(expected = NegativeArraySizeException.class) public void minIntValueArgument() { Main.fib(-2147483648); }
    @Test(expected = Exception.class) public void lessThenMinIntValueArgument() { Main.fib(Integer.parseInt("-2147483649")); }
    @Test(expected = NegativeArraySizeException.class) public void maxIntValueArgument() { Main.fib(2147483647); }
    @Test(expected = Exception.class) public void moreThenMaxIntValueArgument() { Main.fib(Integer.parseInt("2147483648")); }
    ...
    @Test public void internal3(){ assertEquals(new BigInteger("89"), Main.fib(-11));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void internal4(){ assertEquals(new BigInteger("514229"), Main.fib(29));}
    @Test public void internal5(){ assertEquals(new BigInteger("514229"), Main.fib(-29));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void internal6(){ assertEquals(new BigInteger("498454011879264"), Main.fib(72));}
    @Test public void internal7(){ assertEquals(new BigInteger("-498454011879264"), Main.fib(-72));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    /////////////////////////////////////////////////3. Предметная область
    @Test public void subjectArea1() { assertEquals(new BigInteger("1"), Main.fib(1)); }
    @Test public void subjectArea2() { assertEquals(new BigInteger("1"), Main.fib(2)); }
    @Test public void subjectArea3() { assertEquals(new BigInteger("2"), Main.fib(3)); }
    @Test public void subjectArea4() { assertEquals(new BigInteger("3"), Main.fib(4)); }
    @Test public void subjectArea5() { assertEquals(new BigInteger("5"), Main.fib(5)); }
    @Test public void subjectArea6() { assertEquals(new BigInteger("8"), Main.fib(6)); }
    @Test public void subjectArea7() { assertEquals(new BigInteger("13"), Main.fib(7)); }
    @Test public void subjectArea8() { assertEquals(new BigInteger("21"), Main.fib(8)); }
    @Test public void subjectArea9() { assertEquals(new BigInteger("34"), Main.fib(9)); }
    @Test public void subjectArea10() { assertEquals(new BigInteger("55"), Main.fib(10)); }
    @Test public void subjectArea11() { assertEquals(new BigInteger("1"), Main.fib(-1));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea22() { assertEquals(new BigInteger("-1"), Main.fib(-2));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea33() { assertEquals(new BigInteger("2"), Main.fib(-3));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea44() { assertEquals(new BigInteger("-3"), Main.fib(-4));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea55() { assertEquals(new BigInteger("5"), Main.fib(-5));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea66() { assertEquals(new BigInteger("-8"), Main.fib(-6));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea77() { assertEquals(new BigInteger("13"), Main.fib(-7));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea88() { assertEquals(new BigInteger("-21"), Main.fib(-8));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea99() { assertEquals(new BigInteger("34"), Main.fib(-9));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    @Test public void subjectArea1010() { assertEquals(new BigInteger("-55"), Main.fib(-10));assertEquals("Вы ввели отрицателый номер числа Фибоначчи, вот его значение: ", output.toString()); }
    ///////////////////////////////////////////////////////4. Реализация
    @Test public void lowerLimitOfProgram(){ assertEquals(new BigInteger("-3364476487643178326662161200510754331030214846068006390656476997468008" +
            ...
            "54139941550671256271197133252763631939606902895650288268608362241082050562430701794976171121233066073310059947366875"), Main.fib(-10000));
    ...
    @Test(expected = Exception.class) public void incorrectInput(){ Main.fib(Integer.parseInt("hfuvn3737")); }
    /////////////////////////////////////////////////////5.Случайные значения
    @Test public void randomFib1() { assertEquals(new BigInteger("4052739537881"), Main.fib(62)); }
    @Test public void randomFib2() { assertEquals(new BigInteger("-1304969544928657"), Main.fib(-74)); }
    @Test public void randomFib3() { assertEquals(new BigInteger("679891637638612258"), Main.fib(87)); }
    @Test public void randomFib4() { assertEquals(new BigInteger("37889062373143906"), Main.fib(81)); }
    @Test public void randomFib5() { assertEquals(new BigInteger("1134903170"), Main.fib(45)); }
    @Test public void randomFib6() { assertEquals(new BigInteger("9227465"), Main.fib(35)); }
    @Test public void randomFib7() { assertEquals(new BigInteger("10946"), Main.fib(-21)); }
    @Test public void randomFib8() { assertEquals(new BigInteger("196418"), Main.fib(27)); }
}