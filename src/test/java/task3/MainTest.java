...
public class MainTest {
    ...
    public void allMinArgsNOD() throws IOException {
        Main.findNOD(new int[]{Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE});
    }

    @Test
    public void allMaxArgsNOD() throws IOException {
        assertEquals(Integer.MAX_VALUE, Main.findNOD(new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE}));
    }

    @Test
    public void findMinElementWithMinIntTest() {
        assertEquals(-1, Main.findMinABSNotZeroElement(new int[]{Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE}));
    }

    @Test
    public void findMinElementWithMaxIntTest() {
        assertEquals(Integer.MAX_VALUE, Main.findMinABSNotZeroElement(new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE}));
    }

    ////////////////////////////// Особые значения
    @Test
    public void findNodWithZero() throws IOException {
        assertEquals(4, Main.findNOD(new int[]{4, 8, 16, 0}));
    }
    @Test
    public void findMinWithZero() {
        assertEquals(4, Main.findMinABSNotZeroElement(new int[]{4, 8, 16, 0}));
    }

    @Test
    public void findNodWithAllZero() throws IOException {
        assertEquals(2147483647, Main.findNOD(new int[]{0, 0, 0, 0}));
    }

    @Test
    public void findMinWithAllZero() throws IOException {
        assertEquals(2147483647, Main.findNOD(new int[]{0, 0, 0, 0}));
    }
